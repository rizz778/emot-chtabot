...
const Navbar = () => {
  ...
  const backgroundClass =
    location.pathname === "/" || location.pathname === "/avatarexp"
      ? "bg-gradient-to-r from-pink-300 to-[#ffc0cb]"
  ...
  return (
    <header
      className={`flex items-center justify-between p-4 ${backgroundClass} h-20`}
    >
      ...
      <nav className="flex gap-8 font-medium text-lg">
        <NavLink
          to="/"
          className={({ isActive }) =>
            isActive ? "text-black font-bold" : "text-white hover:text-blue-200"
          }
        >
          Home
        </NavLink>
