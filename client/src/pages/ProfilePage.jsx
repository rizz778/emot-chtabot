...
const ProfilePage = () => {
  ...
  const handlePictureUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setEditedUser({...editedUser, profilePicture: file});
      };
  ...
  const saveChanges = () => {
    setUser({...editedUser, profilePicture: previewUrl || user.profilePicture});
    setIsEditing(false);
  };
                ...
                <div className="relative inline-block">
                  {isEditing ? (
                    <div className="relative group">
                      ...
                      <label className="absolute bottom-0 right-0 bg-pink-500 p-2 rounded-full text-white cursor-pointer hover:bg-pink-600 transition-all">
                        <Camera size={16} />
                        <input 
                          type="file" 
                          accept="image/*" 
